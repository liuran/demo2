...
public class ImgResource {
	...
	public static final int[] imageResource = { R.drawable.image_1,
			...
			R.drawable.image_11, R.drawable.image_12, R.drawable.image_13,
			R.drawable.image_14, R.drawable.image_15, R.drawable.image_16,
	...
	public static List<ImageWrapper> genData() {
		...
		int count = ImgResource.imageResource.length / 2
				+ RND.nextInt(ImgResource.imageResource.length / 2);
